...
public class Map {
	...
	public void firstCase() {
		...
		int x = model.mainPlayed.m_x+32*32;
		int y = model.mainPlayed.m_y+24*32;
			...
			for (int j = 0; j < width; j++) {
				...
				if (tab[i][j] == 0) {
					...
					if (j < 32) {
						...
						Sol mTore = new Sol(this.model, this.model.Sprite, 12,11, 32 * j + 64 * 32, 32 * i, 1F, 86,
								true);
					...
					if (i < 24) {
						...
						Sol mTore = new Sol(this.model, this.model.Sprite, 12,11, 32 * j, 32 * i + 48 * 32, 1F, 86,
								true);
